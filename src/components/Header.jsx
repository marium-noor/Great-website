  ...
  return (
    <nav className='fixed top-0 left-0 w-full z-50'>
        <div className='w-full shadow-md z-40 flex flex-col'>
            <div className="h-auto flex bg-black text-white whitespace-nowrap">
                <h4 className="w-full h-full m-auto  uppercase animate-scroll-left text-[10px] lg:text-lg font-medium md:text-md text-center">Discover sneaker perfection</h4>
                <h4 className="w-full h-full m-auto  uppercase animate-scroll-left text-[10px] lg:text-lg font-medium md:text-md text-center">Free shipping $100+</h4>
                <h4 className="w-full h-full m-auto  uppercase animate-scroll-left text-[10px] lg:text-lg font-medium md:text-md text-center">25% on Sidewide</h4>
                <h4 className="w-full h-full m-auto  uppercase animate-scroll-left text-[10px] lg:text-lg font-medium md:text-md text-center">Newyear 70% off</h4>
            </div>
